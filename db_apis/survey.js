...
) VALUES (:ID, :SURVEY_ID, :BUDGET_AMOUNT, :RUNNING_COST_AMOUNT, :INVESTMENT_COST_AMOUNT, :EXECUTION_AMOUNT, :EXECUTION_RUNNING_COST, :EXECUTION_INVESTMENT_COST, :HEMNELT_DUN,  :HEMNELT_PERCENT,  :NEW_EMP_COUNT,  :NEW_EMP_SALARY,  :RENEW_EMP_COUNT,  :RENEW_EMP_SALARY,  
