...
NVL(FDD.IND_VALUE,AE.ENT_NAME) ENT_NAME, AO.ORG_REGISTER_NO, 
FA.AUDIT_CODE, RBT.BUDGET_SHORT_NAME, 
RS1.BUDGET_AMOUNT, RS1.RUNNING_COST_AMOUNT, RS1.INVESTMENT_COST_AMOUNT, RS1.EXECUTION_AMOUNT, RS1.EXECUTION_RUNNING_COST, RS1.EXECUTION_INVESTMENT_COST, RS1.HEMNELT_DUN, 
RS1.NEW_EMP_COUNT, RS1.NEW_EMP_SALARY, RS1.RENEW_EMP_COUNT, RS1.RENEW_EMP_SALARY, RS1.IMP_SALARY_COUNT, RS1.IMP_SALARY_AMOUNT, RS1.IMP_PROMO_COUNT, RS1.IMP_PROMO_AMOUNT, RS1.IMP_GUEST_AMOUNT, RS1.IMP_GIFT_AMOUNT, 
RS1.CAR_COUNT, RS1.CAR_AMOUNT, RS1.FURNITURE_AMOUNT, RS1.CLOTHES_AMOUNT, RS1.OTHER_TOOLS_AMOUNT, RS1.EXTERNAL_EVENT_AMOUNT, RS1.INTERNAL_EVENT_AMOUNT, RS1.CEREMONY_AMOUNT, RS1.CONTENT_AMOUNT, RS1.BASE_PLAN_AMOUNT, 
RS1.BASE_COMPLETION_AMOUNT, RS1.DOCUMENT_PLAN_AMOUNT, RS1.DOCUMENT_COMPLETION_AMOUNT
...
const baseNeg22Query = `SELECT FA.CHECK_DEPARTMENT_ID, CD.DEPARTMENT_NAME,
AE_PARENT.ENT_NAME TEZ_NAME,
AE_TTZ.ENT_NAME TTZ_NAME,
NVL(FDD.IND_VALUE,AE.ENT_NAME) ENT_NAME, AO.ORG_REGISTER_NO, 
FA.AUDIT_CODE, RBT.BUDGET_SHORT_NAME,
RS1.RECEIVE_PREV_AMOUNT ,
RS1.RECEIVE_CY_AMOUNT ,
RS1.RECEIVE_PREV_AMOUNT - RS1.RECEIVE_CY_AMOUNT RECEIVE_MARGIN,
RS1.NONASSET_PREV_AMOUNT ,
RS1.NONASSET_CY_AMOUNT ,
RS1.NONASSET_PREV_AMOUNT - RS1.NONASSET_CY_AMOUNT NONASSET_MARGIN,
RS1.DEBT_PREV_AMOUNT ,
RS1.DEBT_CY_AMOUNT ,
RS1.DEBT_PREV_AMOUNT - RS1.DEBT_CY_AMOUNT DEBT_MARGIN,
RS1.LONG_DEBT_PREV_AMOUNT ,
RS1.LONG_DEBT_CY_AMOUNT ,
RS1.LONG_DEBT_PREV_AMOUNT - RS1.LONG_DEBT_PREV_AMOUNT LONG_DEBT_MARGIN,
--RS1.LONG_DEBT_PAYMENT ,
CASE WHEN RS1.LONG_DEBT_IS_COMPLETE = 1 THEN 'Тийм' END LONG_DEBT_IS_COMPLETE_YES,
CASE WHEN RS1.LONG_DEBT_IS_COMPLETE = 2 THEN 'Үгүй' END LONG_DEBT_IS_COMPLETE_NO,
RS1.PROPERTY_PREV_AMOUNT ,
RS1.PROPERTY_CY_AMOUNT ,
RS1.PROPERTY_PREV_AMOUNT - RS1.PROPERTY_CY_AMOUNT PROPERTY_MARGIN,
RS1.INCOME_PREV_AMOUNT ,
RS1.INCOME_CY_AMOUNT ,
RS1.INCOME_PREV_AMOUNT - RS1.INCOME_CY_AMOUNT INCOME_MARGIN,
RS1.PROFIT_PREV_AMOUNT ,
RS1.PROFIT_CY_AMOUNT ,
RS1.PROFIT_PREV_AMOUNT - RS1.PROFIT_CY_AMOUNT PROFIT_MARGIN,
RS1.INVEST_ORG_PREV_AMOUNT ,
RS1.INVEST_ORG_CY_AMOUNT ,
RS1.INVEST_ORG_PREV_AMOUNT - RS1.INVEST_ORG_CY_AMOUNT INVEST_ORG_MARGIN,
RS1.INVEST_STATE_PREV_AMOUNT ,
RS1.INVEST_STATE_CY_AMOUNT ,
RS1.INVEST_STATE_PREV_AMOUNT - RS1.INVEST_STATE_CY_AMOUNT INVEST_STATE_MARGIN,
RS1.INVEST_LOCAL_PREV_AMOUNT ,
RS1.INVEST_LOCAL_CY_AMOUNT ,
RS1.INVEST_LOCAL_PREV_AMOUNT - RS1.INVEST_LOCAL_CY_AMOUNT INVEST_LOCAL_MARGIN,
RS1.INVEST_PROJECT_PREV_AMOUNT ,
RS1.INVEST_PROJECT_CY_AMOUNT,
RS1.INVEST_PROJECT_PREV_AMOUNT - RS1.INVEST_PROJECT_CY_AMOUNT INVEST_PROJECT_MARGIN
FROM FAS_ADMIN.FAS_AUDIT FA
INNER JOIN AUD_ORG.AUDIT_ENTITY AE ON FA.ENT_ID = AE.ENT_ID
INNER JOIN AUD_ORG.AUDIT_ENTITY AE_PARENT ON AE.ENT_TEZ = AE_PARENT.ENT_ID
LEFT JOIN AUD_ORG.AUDIT_ENTITY AE_TTZ ON AE.ENT_TTZ = AE_TTZ.ENT_ID
...
async function postNeg22(context) {
  let query = baseNeg22Query;
...
const baseNeg23Query = `SELECT FA.CHECK_DEPARTMENT_ID, CD.DEPARTMENT_NAME, 
AE_PARENT.ENT_NAME TEZ_NAME,
AE_TTZ.ENT_NAME TTZ_NAME,
NVL(FDD.IND_VALUE,AE.ENT_NAME) ENT_NAME, AO.ORG_REGISTER_NO, RBT.BUDGET_SHORT_NAME,
COUNT(RS1.ID) MEMBER_COUNT,
SUM(RS1.HEAD_SALARY) MEMBER_SALARY,
SUM(RS1.HEAD_PROMOTION) MEMBER_PROMOTION,
SUM(RS1.SUPPORT_AMOUNT) SUPPORT_AMOUNT,
SUM(CASE WHEN ASSESSMENT = 1 THEN 1 END) ASSESSMENT1,
SUM(CASE WHEN ASSESSMENT = 2 THEN 1 END) ASSESSMENT2,
SUM(CASE WHEN ASSESSMENT = 3 THEN 1 END) ASSESSMENT3,
SUM(CASE WHEN ASSESSMENT = 4 THEN 1 END) ASSESSMENT4,
SUM(CASE WHEN ASSESSMENT = 5 THEN 1 END) ASSESSMENT5
FROM FAS_ADMIN.FAS_AUDIT FA
INNER JOIN AUD_ORG.AUDIT_ENTITY AE ON FA.ENT_ID = AE.ENT_ID
INNER JOIN AUD_ORG.AUDIT_ENTITY AE_PARENT ON AE.ENT_TEZ = AE_PARENT.ENT_ID
LEFT JOIN AUD_ORG.AUDIT_ENTITY AE_TTZ ON AE.ENT_TTZ = AE_TTZ.ENT_ID
...
async function postNeg23(context) {
  let query = baseNeg23Query;
  ...
  query += `\nGROUP BY  FA.CHECK_DEPARTMENT_ID, CD.DEPARTMENT_NAME, AE_PARENT.ENT_NAME,AE_TTZ.ENT_NAME ,NVL(FDD.IND_VALUE,AE.ENT_NAME) , AO.ORG_REGISTER_NO, RBT.BUDGET_SHORT_NAME
  ORDER BY FA.CHECK_DEPARTMENT_ID, AO.ORG_REGISTER_NO, AE_PARENT.ENT_NAME, AE_TTZ.ENT_NAME, RBT.BUDGET_SHORT_NAME`;
  const result = await database.simpleExecute(query, binds);
...
const baseNeg03Query = `SELECT FA.CHECK_DEPARTMENT_ID, CD.DEPARTMENT_NAME, 
AE_PARENT.ENT_NAME TEZ_NAME,
AE_TTZ.ENT_NAME TTZ_NAME,
NVL(FDD.IND_VALUE,AE.ENT_NAME) ENT_NAME, AO.ORG_REGISTER_NO, RBT.BUDGET_SHORT_NAME,
CASE WHEN RS1.PERSON_ROLE_LEVEL = 'Тэргүүн түшмэл' THEN COUNT(RS1.ID) END TER_CNT,
CASE WHEN RS1.PERSON_ROLE_LEVEL = 'Эрхэлсэн түшмэл' THEN COUNT(RS1.ID) END ER_CNT,
CASE WHEN RS1.PERSON_ROLE_LEVEL = 'Тэргүүн түшмэл' THEN ROUND(SUM(RS1.WORKING_ROOM), 2) END TER_WORKING_ROOM,
CASE WHEN RS1.PERSON_ROLE_LEVEL = 'Эрхэлсэн түшмэл' THEN ROUND(SUM(RS1.WORKING_ROOM), 2) END ER_WORKING_ROOM,
CASE WHEN RS1.PERSON_ROLE_LEVEL = 'Тэргүүн түшмэл' THEN ROUND(SUM(RS1.RESTING_ROOM), 2) END TER_RESTING_ROOM,
CASE WHEN RS1.PERSON_ROLE_LEVEL = 'Эрхэлсэн түшмэл' THEN ROUND(SUM(RS1.RESTING_ROOM), 2) END ER_RESTING_ROOM,
CASE WHEN RS1.PERSON_ROLE_LEVEL = 'Тэргүүн түшмэл' THEN ROUND(SUM(RS1.TOILET), 2) END TER_TOILET,
CASE WHEN RS1.PERSON_ROLE_LEVEL = 'Эрхэлсэн түшмэл' THEN ROUND(SUM(RS1.TOILET), 2) END ER_TOILET,
CASE WHEN RS1.PERSON_ROLE_LEVEL = 'Тэргүүн түшмэл' THEN ROUND(SUM(RS1.MEETING_ROOM), 2) END TER_MEETING_ROOM,
CASE WHEN RS1.PERSON_ROLE_LEVEL = 'Эрхэлсэн түшмэл' THEN ROUND(SUM(RS1.MEETING_ROOM), 2) END ER_MEETING_ROOM,
CASE WHEN RS1.PERSON_ROLE_LEVEL = 'Тэргүүн түшмэл' THEN ROUND(SUM(RS1.OTHER_ROOM), 2) END TER_OTHER_ROOM,
CASE WHEN RS1.PERSON_ROLE_LEVEL = 'Эрхэлсэн түшмэл' THEN ROUND(SUM(RS1.OTHER_ROOM), 2) END ER_OTHER_ROOM,
CASE WHEN RS1.PERSON_ROLE_LEVEL = 'Тэргүүн түшмэл' THEN ROUND(SUM(RS1.WORKING_ROOM + RS1.RESTING_ROOM + RS1.TOILET + RS1.MEETING_ROOM + RS1.OTHER_ROOM),2) END TER_TOTAL_AREA,
CASE WHEN RS1.PERSON_ROLE_LEVEL = 'Эрхэлсэн түшмэл' THEN ROUND(SUM(RS1.WORKING_ROOM + RS1.RESTING_ROOM + RS1.TOILET + RS1.MEETING_ROOM + RS1.OTHER_ROOM),2) END ER_TOTAL_AREA
FROM FAS_ADMIN.FAS_AUDIT FA
INNER JOIN AUD_ORG.AUDIT_ENTITY AE ON FA.ENT_ID = AE.ENT_ID
INNER JOIN AUD_ORG.AUDIT_ENTITY AE_PARENT ON AE.ENT_TEZ = AE_PARENT.ENT_ID
LEFT JOIN AUD_ORG.AUDIT_ENTITY AE_TTZ ON AE.ENT_TTZ = AE_TTZ.ENT_ID
...
async function postNeg03(context) {
  let query = baseNeg03Query;
  ...
  query += `\nGROUP BY FA.CHECK_DEPARTMENT_ID, CD.DEPARTMENT_NAME, AE_PARENT.ENT_NAME, AE_TTZ.ENT_NAME ,
  NVL(FDD.IND_VALUE,AE.ENT_NAME), AO.ORG_REGISTER_NO, RBT.BUDGET_SHORT_NAME, RS1.PERSON_ROLE_LEVEL
  ORDER BY FA.CHECK_DEPARTMENT_ID, AO.ORG_REGISTER_NO, AE_PARENT.ENT_NAME, AE_TTZ.ENT_NAME, RBT.BUDGET_SHORT_NAME, RS.ID`;
  const result = await database.simpleExecute(query, binds);
...
const baseNeg04Query = `SELECT FA.CHECK_DEPARTMENT_ID, CD.DEPARTMENT_NAME, 
AE_PARENT.ENT_NAME TEZ_NAME,
AE_TTZ.ENT_NAME TTZ_NAME,
NVL(FDD.IND_VALUE,AE.ENT_NAME) ENT_NAME, AO.ORG_REGISTER_NO, RBT.BUDGET_SHORT_NAME,
ROUND(SUM(RS1.RENT_SIZE), 2) RENT_SIZE,
ROUND(AVG(RS1.RENT_SQUARE_AMOUNT), 2) RENT_SQUARE_AMOUNT,
ROUND(SUM(RS1.RENT_TOTAL_AMOUNT), 2) RENT_TOTAL_AMOUNT,
SUM(CASE WHEN RS1.INVEST_TYPE_ID = 1 THEN 1 END ) INVEST_TYPE1,
SUM(CASE WHEN RS1.INVEST_TYPE_ID = 2 THEN 1 END ) INVEST_TYPE2,
SUM(CASE WHEN RS1.INVEST_TYPE_ID = 3 THEN 1 END ) INVEST_TYPE3
FROM FAS_ADMIN.FAS_AUDIT FA
INNER JOIN AUD_ORG.AUDIT_ENTITY AE ON FA.ENT_ID = AE.ENT_ID
INNER JOIN AUD_ORG.AUDIT_ENTITY AE_PARENT ON AE.ENT_TEZ = AE_PARENT.ENT_ID
LEFT JOIN AUD_ORG.AUDIT_ENTITY AE_TTZ ON AE.ENT_TTZ = AE_TTZ.ENT_ID
...
async function postNeg04(context) {
  let query = baseNeg04Query;
  ...
  query += `\nGROUP BY FA.CHECK_DEPARTMENT_ID, CD.DEPARTMENT_NAME, AE_PARENT.ENT_NAME, AE_TTZ.ENT_NAME ,
  NVL(FDD.IND_VALUE,AE.ENT_NAME), AO.ORG_REGISTER_NO, RBT.BUDGET_SHORT_NAME 
  ORDER BY FA.CHECK_DEPARTMENT_ID, AO.ORG_REGISTER_NO, AE_PARENT.ENT_NAME, AE_TTZ.ENT_NAME, RBT.BUDGET_SHORT_NAME`;
  const result = await database.simpleExecute(query, binds);
...
const baseNeg05Query = `SELECT FA.CHECK_DEPARTMENT_ID, CD.DEPARTMENT_NAME, 
AE_PARENT.ENT_NAME TEZ_NAME,
AE_TTZ.ENT_NAME TTZ_NAME,
NVL(FDD.IND_VALUE,AE.ENT_NAME) ENT_NAME, AO.ORG_REGISTER_NO, RBT.BUDGET_SHORT_NAME,
COUNT(RS1.ID) CONTRACT_CNT,
ROUND(SUM(RS1.CONTRACT_AMOUNT), 2) CONTRACT_AMOUNT,
ROUND(SUM(RS1.CY_INVEST_AMOUNT), 2) CY_INVEST_AMOUNT,
SUM(CASE WHEN RS1.IS_CONCLUTION = 1 THEN 1 END) IS_CONCLUTION_YES,
SUM(CASE WHEN RS1.IS_CONCLUTION = 2 THEN 1 END) IS_CONCLUTION_NO,
SUM(CASE WHEN RS1.IS_REQUIRED = 1 THEN 1 END) IS_REQUIRED_YES,
SUM(CASE WHEN RS1.IS_REQUIRED = 2 THEN 1 END) IS_REQUIRED_NO
FROM FAS_ADMIN.FAS_AUDIT FA
INNER JOIN AUD_ORG.AUDIT_ENTITY AE ON FA.ENT_ID = AE.ENT_ID
INNER JOIN AUD_ORG.AUDIT_ENTITY AE_PARENT ON AE.ENT_TEZ = AE_PARENT.ENT_ID
LEFT JOIN AUD_ORG.AUDIT_ENTITY AE_TTZ ON AE.ENT_TTZ = AE_TTZ.ENT_ID
...
async function postNeg05(context) {
  let query = baseNeg05Query;
...
const baseNeg06Query = `SELECT FA.CHECK_DEPARTMENT_ID, CD.DEPARTMENT_NAME, 
AE_PARENT.ENT_NAME TEZ_NAME,
AE_TTZ.ENT_NAME TTZ_NAME,
NVL(FDD.IND_VALUE,AE.ENT_NAME) ENT_NAME, AO.ORG_REGISTER_NO, RBT.BUDGET_SHORT_NAME,
RS1.DONATER_NAME,
ROUND(SUM(CASE WHEN RS1.DONATION_TYPE_ID = 1 THEN RS1.DONATION_AMOUNT END ),2) DONATION_AMOUNT1,
ROUND(SUM(CASE WHEN RS1.DONATION_TYPE_ID = 2 THEN RS1.DONATION_AMOUNT END ),2) DONATION_AMOUNT2,
ROUND(SUM(CASE WHEN RS1.DONATION_TYPE_ID = 3 THEN RS1.DONATION_AMOUNT END ),2) DONATION_AMOUNT3,
ROUND(SUM(CASE WHEN RS1.DONATION_TYPE_ID = 4 THEN RS1.DONATION_AMOUNT END ),2) DONATION_AMOUNT4,
ROUND(SUM(RS1.DONATION_AMOUNT),2) DONATION_AMOUNT_TOTAL,
ROUND(SUM(RS1.ACCOUNT_AMOUNT),2) ACCOUNT_AMOUNT,
ROUND(SUM(RS1.COST_AMOUNT),2) COST_AMOUNT,
ROUND(SUM(RS1.COST_ERROR_AMOUNT),2) COST_ERROR_AMOUNT,
ROUND(SUM(RS1.C2_AMOUNT),2) C2_AMOUNT
FROM FAS_ADMIN.FAS_AUDIT FA
INNER JOIN AUD_ORG.AUDIT_ENTITY AE ON FA.ENT_ID = AE.ENT_ID
INNER JOIN AUD_ORG.AUDIT_ENTITY AE_PARENT ON AE.ENT_TEZ = AE_PARENT.ENT_ID
LEFT JOIN AUD_ORG.AUDIT_ENTITY AE_TTZ ON AE.ENT_TTZ = AE_TTZ.ENT_ID
...
async function postNeg06(context) {
  let query = baseNeg06Query;
  ...
  query += `\nGROUP BY FA.CHECK_DEPARTMENT_ID, CD.DEPARTMENT_NAME, AE_PARENT.ENT_NAME, AE_TTZ.ENT_NAME,
  NVL(FDD.IND_VALUE,AE.ENT_NAME), AO.ORG_REGISTER_NO, RBT.BUDGET_SHORT_NAME, RS1.DONATER_NAME
  ORDER BY FA.CHECK_DEPARTMENT_ID, AO.ORG_REGISTER_NO, AE_PARENT.ENT_NAME, AE_TTZ.ENT_NAME, RBT.BUDGET_SHORT_NAME, RS.ID`;
  const result = await database.simpleExecute(query, binds);
...
const baseNeg07Query = `SELECT FA.CHECK_DEPARTMENT_ID, CD.DEPARTMENT_NAME, 
AE_PARENT.ENT_NAME TEZ_NAME,
AE_TTZ.ENT_NAME TTZ_NAME,
NVL(FDD.IND_VALUE,AE.ENT_NAME) ENT_NAME, AO.ORG_REGISTER_NO, RBT.BUDGET_SHORT_NAME,
--RS1.HOSPITAL_NAME,
SUM(RS1.PATIENT_COUNT) PATIENT_COUNT,
SUM(RS1.HOME_PATIENT_COUNT) HOME_PATIENT_COUNT,
ROUND(SUM(RS1.REQUEST_AMOUNT),2) REQUEST_AMOUNT,
ROUND(SUM(RS1.INVESTED_AMOUNT),2) INVESTED_AMOUNT,
ROUND(SUM(RS1.TOTAL_COST_AMOUNT),2) TOTAL_COST_AMOUNT,
SUM(RS1.PACKAGE_COUNT) PACKAGE_COUNT,
ROUND(SUM(RS1.PACKAGE_AMOUNT),2) PACKAGE_AMOUNT,
ROUND(SUM(RS1.PROTECTION_COST),2) PROTECTION_COST,
ROUND(SUM(RS1.GAS_COST),2) GAS_COST,
ROUND(SUM(RS1.PHONE_COST),2) PHONE_COST,
ROUND(SUM(RS1.SALARY_COST),2) SALARY_COST,
ROUND(SUM(RS1.PROCESS_COST),2) PROCESS_COST,
ROUND(SUM(RS1.PREPARE_COST),2) PREPARE_COST,
ROUND(SUM(RS1.OTHER_COST),2) OTHER_COST,
ROUND(SUM(RS1.RECEIVE_AMOUNT),2) RECEIVE_AMOUNT,
ROUND(SUM(RS1.DIFF_AMOUNT),2) DIFF_AMOUNT,
ROUND(SUM(RS1.PACKAGE_C2_COUNT),2) PACKAGE_C2_COUNT,
ROUND(SUM(RS1.PACKAGE_C2_AMOUNT),2) PACKAGE_C2_AMOUNT
FROM FAS_ADMIN.FAS_AUDIT FA
INNER JOIN AUD_ORG.AUDIT_ENTITY AE ON FA.ENT_ID = AE.ENT_ID
INNER JOIN AUD_ORG.AUDIT_ENTITY AE_PARENT ON AE.ENT_TEZ = AE_PARENT.ENT_ID
LEFT JOIN AUD_ORG.AUDIT_ENTITY AE_TTZ ON AE.ENT_TTZ = AE_TTZ.ENT_ID
...
async function postNeg07(context) {
  let query = baseNeg07Query;
...
const baseNeg08Query = `SELECT FA.CHECK_DEPARTMENT_ID, CD.DEPARTMENT_NAME, 
AE_PARENT.ENT_NAME TEZ_NAME,
AE_TTZ.ENT_NAME TTZ_NAME,
NVL(FDD.IND_VALUE,AE.ENT_NAME) ENT_NAME, AO.ORG_REGISTER_NO, RBT.BUDGET_SHORT_NAME,
SUM(CASE WHEN RS1.CAR_ENGINE <= 2500 THEN 1 END) ENGINE_2500,
SUM(CASE WHEN RS1.CAR_ENGINE > 2500 AND RS1.CAR_ENGINE <= 4700 THEN 1 END) ENGINE_4700,
SUM(CASE WHEN RS1.CAR_ENGINE > 4700 THEN 1 END) ENGINE_MAX,
SUM(CASE WHEN RS1.CAR_INTENT_TYPE_ID = 1 THEN 1 END) INTENT1,
SUM(CASE WHEN RS1.CAR_INTENT_TYPE_ID = 2 THEN 1 END) INTENT2,
SUM(CASE WHEN RS1.CAR_INTENT_TYPE_ID = 3 THEN 1 END) INTENT3,
COUNT(RS1.DRIVER_ROLE) DRIVER_CNT,
SUM(RS1.DRIVER_SALARY) DRIVER_SALARY,
--RS1.ACTIVE_YEAR,
'',
'',
'',
ROUND(SUM(RS1.BALANCE_AMOUNT), 2) BALANCE_AMOUNT,
ROUND(SUM(RS1.GAS_COST_AMOUNT), 2) GAS_COST_AMOUNT,
ROUND(SUM(CASE WHEN RS1.GAS_COST_BUDGET = 'Батлагдсан төсвөөс' THEN RS1.GAS_COST_AMOUNT END), 2) GAS_COST_BUDGET1,
ROUND(SUM(CASE WHEN RS1.GAS_COST_BUDGET = 'Дээд шатны байгууллагын төсвөөс' THEN RS1.GAS_COST_AMOUNT END), 2) GAS_COST_BUDGET2,
ROUND(SUM(CASE WHEN RS1.GAS_COST_BUDGET = 'Харьяа байгууллагын төсвөөс' THEN RS1.GAS_COST_AMOUNT END), 2) GAS_COST_BUDGET3,
ROUND(SUM(RS1.SPARE_COST_AMOUNT), 2) SPARE_COST_AMOUNT,
ROUND(SUM(CASE WHEN RS1.SPARE_COST_BUDGET = 'Батлагдсан төсвөөс' THEN RS1.SPARE_COST_AMOUNT END), 2) SPARE_COST_BUDGET1,
ROUND(SUM(CASE WHEN RS1.SPARE_COST_BUDGET = 'Дээд шатны байгууллагын төсвөөс' THEN RS1.SPARE_COST_AMOUNT END), 2) SPARE_COST_BUDGET2,
ROUND(SUM(CASE WHEN RS1.SPARE_COST_BUDGET = 'Харьяа байгууллагын төсвөөс' THEN RS1.SPARE_COST_AMOUNT END), 2) SPARE_COST_BUDGET3
FROM FAS_ADMIN.FAS_AUDIT FA
INNER JOIN AUD_ORG.AUDIT_ENTITY AE ON FA.ENT_ID = AE.ENT_ID
INNER JOIN AUD_ORG.AUDIT_ENTITY AE_PARENT ON AE.ENT_TEZ = AE_PARENT.ENT_ID
LEFT JOIN AUD_ORG.AUDIT_ENTITY AE_TTZ ON AE.ENT_TTZ = AE_TTZ.ENT_ID
...
async function postNeg08(context) {
  let query = baseNeg08Query;
...
const baseNeg09Query = `SELECT FA.CHECK_DEPARTMENT_ID, CD.DEPARTMENT_NAME, 
AE_PARENT.ENT_NAME TEZ_NAME,
AE_TTZ.ENT_NAME TTZ_NAME,
NVL(FDD.IND_VALUE,AE.ENT_NAME) ENT_NAME, AO.ORG_REGISTER_NO, RBT.BUDGET_SHORT_NAME,
COUNT(RS1.ID) ATHLETE_CNT,
COUNT(DISTINCT RS1.ATHLETE_SPORT) ATHLETE_SPORT,
ROUND(SUM(RS1.SALARY_TITLE_AMOUNT), 2) SALARY_TITLE_AMOUNT,
ROUND(SUM(RS1.SALARY_BASE_AMOUNT), 2) SALARY_BASE_AMOUNT,
ROUND(SUM(RS1.SALARY_DEGREE_AMOUNT), 2) SALARY_DEGREE_AMOUNT,
ROUND(SUM(RS1.PROMO_AMOUNT), 2) PROMO_AMOUNT,
ROUND(SUM(RS1.NON_MONEY_PRICE), 2) NON_MONEY_PRICE,
ROUND(SUM(RS1.TOTAL_AMOUNT), 2) TOTAL_AMOUNT
FROM FAS_ADMIN.FAS_AUDIT FA
INNER JOIN AUD_ORG.AUDIT_ENTITY AE ON FA.ENT_ID = AE.ENT_ID
INNER JOIN AUD_ORG.AUDIT_ENTITY AE_PARENT ON AE.ENT_TEZ = AE_PARENT.ENT_ID
LEFT JOIN AUD_ORG.AUDIT_ENTITY AE_TTZ ON AE.ENT_TTZ = AE_TTZ.ENT_ID
...
async function postNeg09(context) {
  let query = baseNeg09Query;
...
const baseNeg10Query = `SELECT 
FA.CHECK_DEPARTMENT_ID, CD.DEPARTMENT_NAME, 
AE_PARENT.ENT_NAME TEZ_NAME,
AE_TTZ.ENT_NAME TTZ_NAME,
NVL(FDD.IND_VALUE,AE.ENT_NAME) ENT_NAME, AO.ORG_REGISTER_NO, RBT.BUDGET_SHORT_NAME,
COUNT(DISTINCT RS1.MEDIA_NAME) MEDIA_CNT,
COUNT(CASE WHEN RS1.MEDIA_TYPE = 'Телевиз' THEN 1 END) MEDIA_TV,
COUNT(CASE WHEN RS1.MEDIA_TYPE = 'Сонин, сэтгүүл' THEN 1 END) MEDIA_NEWS,
COUNT(CASE WHEN RS1.MEDIA_TYPE = 'Цахим сайт' THEN 1 END) MEDIA_SITE,
COUNT(CASE WHEN RS1.MEDIA_TYPE = 'Радио, FM' THEN 1 END) MEDIA_FM,
ROUND(SUM(RS1.CONTRACT_AMOUNT), 2) CONTRACT_AMOUNT,
COUNT(CASE WHEN RS1.PROCUREMENT_TYPE = 'Шууд худалдан авалт' THEN 1 END) PROCUREMENT_TYPE1,
COUNT(CASE WHEN RS1.PROCUREMENT_TYPE = 'Харьцуулсан тендер' THEN 1 END) PROCUREMENT_TYPE2,
COUNT(CASE WHEN RS1.PROCUREMENT_TYPE = 'Нээлттэй тендер' THEN 1 END) PROCUREMENT_TYPE3,
COUNT(CASE WHEN RS1.IS_PLANNED = 1 THEN 1 END) IS_PLANNED_YES,
COUNT(CASE WHEN RS1.IS_PLANNED = 2 THEN 1 END) IS_PLANNED_NO,
COUNT(CASE WHEN RS1.IS_PREV = 1 THEN 1 END) IS_PREV_YES,
COUNT(CASE WHEN RS1.IS_PREV = 2 THEN 1 END) IS_PREV_NO
FROM FAS_ADMIN.FAS_AUDIT FA
INNER JOIN AUD_ORG.AUDIT_ENTITY AE ON FA.ENT_ID = AE.ENT_ID
INNER JOIN AUD_ORG.AUDIT_ENTITY AE_PARENT ON AE.ENT_TEZ = AE_PARENT.ENT_ID
LEFT JOIN AUD_ORG.AUDIT_ENTITY AE_TTZ ON AE.ENT_TTZ = AE_TTZ.ENT_ID
...
async function postNeg10(context) {
  let query = baseNeg10Query;
