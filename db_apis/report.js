...
SUM(CASE WHEN A1.SURVEY_STATUS_ID = 2 THEN 1 ELSE 0 END) S1_SAVE, SUM(CASE WHEN A1.SURVEY_STATUS_ID = 3 THEN 1 ELSE 0 END) S1_SENT, SUM(CASE WHEN A1.SURVEY_STATUS_ID = 4 THEN 1 ELSE 0 END) S1_HAM, SUM(CASE WHEN A1.SURVEY_STATUS_ID = 1 THEN 1 ELSE 0 END) S1_NEW, SUM(CASE WHEN A1.SURVEY_STATUS_ID = 5 THEN 1 ELSE 0 END) S1_CONFIRM, SUM(CASE WHEN A1.SURVEY_STATUS_ID = 6 THEN 1 ELSE 0 END) S1_RETURN,
SUM(CASE WHEN A21.SURVEY_STATUS_ID = 2 THEN 1 ELSE 0 END) S21_SAVE, SUM(CASE WHEN A21.SURVEY_STATUS_ID = 3 THEN 1 ELSE 0 END) S21_SENT, SUM(CASE WHEN A21.SURVEY_STATUS_ID = 4 THEN 1 ELSE 0 END) S21_HAM, SUM(CASE WHEN A21.SURVEY_STATUS_ID = 1 THEN 1 ELSE 0 END) S21_NEW, SUM(CASE WHEN A21.SURVEY_STATUS_ID = 5 THEN 1 ELSE 0 END) S21_CONFIRM, SUM(CASE WHEN A21.SURVEY_STATUS_ID = 6 THEN 1 ELSE 0 END) S21_RETURN,
SUM(CASE WHEN A22.SURVEY_STATUS_ID = 2 THEN 1 ELSE 0 END) S22_SAVE, SUM(CASE WHEN A22.SURVEY_STATUS_ID = 3 THEN 1 ELSE 0 END) S22_SENT, SUM(CASE WHEN A22.SURVEY_STATUS_ID = 4 THEN 1 ELSE 0 END) S22_HAM, SUM(CASE WHEN A22.SURVEY_STATUS_ID = 1 THEN 1 ELSE 0 END) S22_NEW, SUM(CASE WHEN A22.SURVEY_STATUS_ID = 5 THEN 1 ELSE 0 END) S22_CONFIRM, SUM(CASE WHEN A22.SURVEY_STATUS_ID = 6 THEN 1 ELSE 0 END) S22_RETURN,
SUM(CASE WHEN A23.SURVEY_STATUS_ID = 2 THEN 1 ELSE 0 END) S23_SAVE, SUM(CASE WHEN A23.SURVEY_STATUS_ID = 3 THEN 1 ELSE 0 END) S23_SENT, SUM(CASE WHEN A23.SURVEY_STATUS_ID = 4 THEN 1 ELSE 0 END) S23_HAM, SUM(CASE WHEN A23.SURVEY_STATUS_ID = 1 THEN 1 ELSE 0 END) S23_NEW, SUM(CASE WHEN A23.SURVEY_STATUS_ID = 5 THEN 1 ELSE 0 END) S23_CONFIRM, SUM(CASE WHEN A23.SURVEY_STATUS_ID = 6 THEN 1 ELSE 0 END) S23_RETURN,
SUM(CASE WHEN A3.SURVEY_STATUS_ID = 2 THEN 1 ELSE 0 END) S3_SAVE, SUM(CASE WHEN A3.SURVEY_STATUS_ID = 3 THEN 1 ELSE 0 END) S3_SENT, SUM(CASE WHEN A3.SURVEY_STATUS_ID = 4 THEN 1 ELSE 0 END) S3_HAM, SUM(CASE WHEN A3.SURVEY_STATUS_ID = 1 THEN 1 ELSE 0 END) S3_NEW, SUM(CASE WHEN A3.SURVEY_STATUS_ID = 5 THEN 1 ELSE 0 END) S3_CONFIRM, SUM(CASE WHEN A3.SURVEY_STATUS_ID = 6 THEN 1 ELSE 0 END) S3_RETURN,
SUM(CASE WHEN A4.SURVEY_STATUS_ID = 2 THEN 1 ELSE 0 END) S4_SAVE, SUM(CASE WHEN A4.SURVEY_STATUS_ID = 3 THEN 1 ELSE 0 END) S4_SENT, SUM(CASE WHEN A4.SURVEY_STATUS_ID = 4 THEN 1 ELSE 0 END) S4_HAM, SUM(CASE WHEN A4.SURVEY_STATUS_ID = 1 THEN 1 ELSE 0 END) S4_NEW, SUM(CASE WHEN A4.SURVEY_STATUS_ID = 5 THEN 1 ELSE 0 END) S4_CONFIRM, SUM(CASE WHEN A4.SURVEY_STATUS_ID = 6 THEN 1 ELSE 0 END) S4_RETURN,
SUM(CASE WHEN A5.SURVEY_STATUS_ID = 2 THEN 1 ELSE 0 END) S5_SAVE, SUM(CASE WHEN A5.SURVEY_STATUS_ID = 3 THEN 1 ELSE 0 END) S5_SENT, SUM(CASE WHEN A5.SURVEY_STATUS_ID = 4 THEN 1 ELSE 0 END) S5_HAM, SUM(CASE WHEN A5.SURVEY_STATUS_ID = 1 THEN 1 ELSE 0 END) S5_NEW, SUM(CASE WHEN A5.SURVEY_STATUS_ID = 5 THEN 1 ELSE 0 END) S5_CONFIRM, SUM(CASE WHEN A5.SURVEY_STATUS_ID = 6 THEN 1 ELSE 0 END) S5_RETURN,
SUM(CASE WHEN A6.SURVEY_STATUS_ID = 2 THEN 1 ELSE 0 END) S6_SAVE, SUM(CASE WHEN A6.SURVEY_STATUS_ID = 3 THEN 1 ELSE 0 END) S6_SENT, SUM(CASE WHEN A6.SURVEY_STATUS_ID = 4 THEN 1 ELSE 0 END) S6_HAM, SUM(CASE WHEN A6.SURVEY_STATUS_ID = 1 THEN 1 ELSE 0 END) S6_NEW, SUM(CASE WHEN A6.SURVEY_STATUS_ID = 5 THEN 1 ELSE 0 END) S6_CONFIRM, SUM(CASE WHEN A6.SURVEY_STATUS_ID = 6 THEN 1 ELSE 0 END) S6_RETURN,
SUM(CASE WHEN A7.SURVEY_STATUS_ID = 2 THEN 1 ELSE 0 END) S7_SAVE, SUM(CASE WHEN A7.SURVEY_STATUS_ID = 3 THEN 1 ELSE 0 END) S7_SENT, SUM(CASE WHEN A7.SURVEY_STATUS_ID = 4 THEN 1 ELSE 0 END) S7_HAM, SUM(CASE WHEN A7.SURVEY_STATUS_ID = 1 THEN 1 ELSE 0 END) S7_NEW, SUM(CASE WHEN A7.SURVEY_STATUS_ID = 5 THEN 1 ELSE 0 END) S7_CONFIRM, SUM(CASE WHEN A7.SURVEY_STATUS_ID = 6 THEN 1 ELSE 0 END) S7_RETURN,
SUM(CASE WHEN A8.SURVEY_STATUS_ID = 2 THEN 1 ELSE 0 END) S8_SAVE, SUM(CASE WHEN A8.SURVEY_STATUS_ID = 3 THEN 1 ELSE 0 END) S8_SENT, SUM(CASE WHEN A8.SURVEY_STATUS_ID = 4 THEN 1 ELSE 0 END) S8_HAM, SUM(CASE WHEN A8.SURVEY_STATUS_ID = 1 THEN 1 ELSE 0 END) S8_NEW, SUM(CASE WHEN A8.SURVEY_STATUS_ID = 5 THEN 1 ELSE 0 END) S8_CONFIRM, SUM(CASE WHEN A8.SURVEY_STATUS_ID = 6 THEN 1 ELSE 0 END) S8_RETURN,
SUM(CASE WHEN A9.SURVEY_STATUS_ID = 2 THEN 1 ELSE 0 END) S9_SAVE, SUM(CASE WHEN A9.SURVEY_STATUS_ID = 3 THEN 1 ELSE 0 END) S9_SENT, SUM(CASE WHEN A9.SURVEY_STATUS_ID = 4 THEN 1 ELSE 0 END) S9_HAM, SUM(CASE WHEN A9.SURVEY_STATUS_ID = 1 THEN 1 ELSE 0 END) S9_NEW, SUM(CASE WHEN A9.SURVEY_STATUS_ID = 5 THEN 1 ELSE 0 END) S9_CONFIRM, SUM(CASE WHEN A9.SURVEY_STATUS_ID = 6 THEN 1 ELSE 0 END) S9_RETURN,
SUM(CASE WHEN A10.SURVEY_STATUS_ID = 2 THEN 1 ELSE 0 END) S10_SAVE, SUM(CASE WHEN A10.SURVEY_STATUS_ID = 3 THEN 1 ELSE 0 END) S10_SENT, SUM(CASE WHEN A10.SURVEY_STATUS_ID = 4 THEN 1 ELSE 0 END) S10_HAM, SUM(CASE WHEN A10.SURVEY_STATUS_ID = 1 THEN 1 ELSE 0 END) S10_NEW, SUM(CASE WHEN A10.SURVEY_STATUS_ID = 5 THEN 1 ELSE 0 END) S10_CONFIRM, SUM(CASE WHEN A10.SURVEY_STATUS_ID = 6 THEN 1 ELSE 0 END) S10_RETURN
...
//Zadargaa tailan
const baseZad01Query = `SELECT FA.CHECK_DEPARTMENT_ID, CD.DEPARTMENT_NAME, AE.ENT_NAME, AO.ORG_REGISTER_NO, RBT.BUDGET_SHORT_NAME, --RS1.ID, RS1.SURVEY_ID,
...
async function postZad01(context) {
  ...
  query += `\nORDER BY FA.CHECK_DEPARTMENT_ID, RS1.ID, AO.ORG_REGISTER_NO`;
  const result = await database.simpleExecute(query, binds);
...
const baseZad21Query = `SELECT FA.CHECK_DEPARTMENT_ID, CD.DEPARTMENT_NAME, AE.ENT_NAME, AO.ORG_REGISTER_NO, RBT.BUDGET_SHORT_NAME, --RS1.ID, RS1.SURVEY_ID,
...
const baseZad22Query = `SELECT FA.CHECK_DEPARTMENT_ID, CD.DEPARTMENT_NAME, AE.ENT_NAME, AO.ORG_REGISTER_NO, RBT.BUDGET_SHORT_NAME, --RS1.ID, RS1.SURVEY_ID,
...
const baseZad23Query = `SELECT FA.CHECK_DEPARTMENT_ID, CD.DEPARTMENT_NAME, AE.ENT_NAME, AO.ORG_REGISTER_NO, RBT.BUDGET_SHORT_NAME, --RS1.ID, RS1.SURVEY_ID,
RS1.HEAD_ROLE ,
RS1.HEAD_DATE ,
...
const baseZad03Query = `SELECT FA.CHECK_DEPARTMENT_ID, CD.DEPARTMENT_NAME, AE.ENT_NAME, AO.ORG_REGISTER_NO, RBT.BUDGET_SHORT_NAME, --RS1.ID, RS1.SURVEY_ID,
...
const baseZad04Query = `SELECT FA.CHECK_DEPARTMENT_ID, CD.DEPARTMENT_NAME, AE.ENT_NAME, AO.ORG_REGISTER_NO, RBT.BUDGET_SHORT_NAME, --RS1.ID, RS1.SURVEY_ID,
...
const baseZad05Query = `SELECT FA.CHECK_DEPARTMENT_ID, CD.DEPARTMENT_NAME, AE.ENT_NAME, AO.ORG_REGISTER_NO, RBT.BUDGET_SHORT_NAME, --RS1.ID, RS1.SURVEY_ID,
...
const baseZad06Query = `SELECT FA.CHECK_DEPARTMENT_ID, CD.DEPARTMENT_NAME, AE.ENT_NAME, AO.ORG_REGISTER_NO, RBT.BUDGET_SHORT_NAME, --RS1.ID, RS1.SURVEY_ID,
...
const baseZad07Query = `SELECT FA.CHECK_DEPARTMENT_ID, CD.DEPARTMENT_NAME, AE.ENT_NAME, AO.ORG_REGISTER_NO, RBT.BUDGET_SHORT_NAME, --RS1.ID, RS1.SURVEY_ID,
...
const baseZad08Query = `SELECT FA.CHECK_DEPARTMENT_ID, CD.DEPARTMENT_NAME, AE.ENT_NAME, AO.ORG_REGISTER_NO, RBT.BUDGET_SHORT_NAME, --RS1.ID, RS1.SURVEY_ID,
...
const baseZad09Query = `SELECT FA.CHECK_DEPARTMENT_ID, CD.DEPARTMENT_NAME, AE.ENT_NAME, AO.ORG_REGISTER_NO, RBT.BUDGET_SHORT_NAME, --RS1.ID, RS1.SURVEY_ID,
...
FA.CHECK_DEPARTMENT_ID, CD.DEPARTMENT_NAME, AE.ENT_NAME, AO.ORG_REGISTER_NO, RBT.BUDGET_SHORT_NAME,
RS1.media_name,
