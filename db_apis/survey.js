...
const createSqlSurvey1 = `INSERT INTO AUD_PUBLIC.REG_SURVEY_1 (  SURVEY_ID,  HEMNELT_DUN,  HEMNELT_PERCENT,  NEW_EMP_COUNT,  NEW_EMP_SALARY,  RENEW_EMP_COUNT,  RENEW_EMP_SALARY,  
  ...
  CREATED_BY,
  CREATED_DATE
) VALUES ( :SURVEY_ID,  :HEMNELT_DUN,  :HEMNELT_PERCENT,  :NEW_EMP_COUNT,  :NEW_EMP_SALARY,  :RENEW_EMP_COUNT,  :RENEW_EMP_SALARY,  
  :IMP_SALARY_COUNT,  :IMP_SALARY_AMOUNT,  :IMP_PROMO_COUNT,  :IMP_PROMO_AMOUNT,  :IMP_GUEST_AMOUNT,  :IMP_GIFT_AMOUNT,  :CAR_COUNT,  :CAR_AMOUNT,  :FURNITURE_AMOUNT,  :CLOTHES_AMOUNT,
  :OTHER_TOOLS_AMOUNT,  :EXTERNAL_EVENT_AMOUNT,  :INTERNAL_EVENT_AMOUNT,  :CEREMONY_AMOUNT,  :CONTENT_AMOUNT,  :BASE_PLAN_AMOUNT,  :BASE_COMPLETION_AMOUNT,  :BASE_PERCENT,  :DOCUMENT_PLAN_AMOUNT,
  :DOCUMENT_COMPLETION_AMOUNT,  :DOCUMENT_PERCENT,  1,  :CREATED_BY,  SYSDATE)`;

async function createSurvey1(data) {
...
module.exports.createSurvey1 = createSurvey1;
...
async function updateSurvey1(data) {
...
module.exports.updateSurvey1 = updateSurvey1;
