...
VALUES (:ID, :SURVEY_ID, :RECEIVE_PREV_AMOUNT, :RECEIVE_CY_AMOUNT, :RECEIVE_DESCRIPTION, :NONASSET_PREV_AMOUNT, :NONASSET_CY_AMOUNT, :NONASSET_DESCRIPTION, :DEBT_PREV_AMOUNT, :DEBT_CY_AMOUNT, :DEBT_DESCRIPTION, :LONG_DEBT_PREV_AMOUNT, :LONG_DEBT_CY_AMOUNT, :LONG_DEBT_DESCRIPTION, :LONG_DEBT_PAYMENT, :LONG_DEBT_IS_COMPLETE, :PROPERTY_PREV_AMOUNT, :PROPERTY_CY_AMOUNT, :PROPERTY_DESCRIPTION, :INCOME_PREV_AMOUNT, :INCOME_CY_AMOUNT, :INCOME_DESCRIPTION, :PROFIT_PREV_AMOUNT, :PROFIT_CY_AMOUNT, :INVEST_ORG_PREV_AMOUNT, :INVEST_ORG_CY_AMOUNT, :INVEST_STATE_PREV_AMOUNT, :INVEST_STATE_CY_AMOUNT, :INVEST_LOCAL_PREV_AMOUNT, :INVEST_LOCAL_CY_AMOUNT, :INVEST_PROJECT_PREV_AMOUNT, :INVEST_PROJECT_CY_AMOUNT,
